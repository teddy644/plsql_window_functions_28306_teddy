...
Camellia Restaurant should promote low performing items and implement loyalty programs for high value customers.and introduce loyalty programs and focus on marketing on top performing meals.
...
- [W3Schools SQL Window Functions Tutorial](https://www.w3schools.com/sql/sql_window_functions.asp)



- [Camellia Restaurant Official Website](https://cafecamellia.rw/)

- [Draw.io (diagrams.net) – ER Diagram Tool](https://www.diagrams.net/)
